      ...
      return (
        <>
          ...
          />
          {
            // 这里是没有对话时的设置
            !currentConversationId && (
              <div className={`mx-auto w-full max-w-[960px] ${isMobile && 'px-4'}`}>
                <div className='mb-6' />
                <ConfigPanel />
                <div
  ...
  return (
    ...
    >
      <Chat
        ...
        chatContainerInnerClassName={`mx-auto pt-6 w-full max-w-[960px] ${isMobile && 'px-4'}`}
        chatFooterClassName='pb-4'
        chatFooterInnerClassName={`mx-auto w-full max-w-[960px] ${isMobile && 'px-4'}`}
        onSend={doSend}
